...
func (t *Template) ExecuteTemplate(wr *mmsg.MSG, name string, data interface{}) error {
	tmpl := t.Lookup(name)
	if tmpl == nil {
...
func (t *Template) Execute(wr *mmsg.MSG, data interface{}) error {
